...
class TeacherService:
    ...
    def get_teacher_by_employee_id(
        ...
        return (
            self.db.query(Teacher)
            .filter(Teacher.employee_id == employee_id, Teacher.tenant_id == tenant_id)
            .first()
        )
    ...
    def update_teacher(
        self, teacher_id: int, teacher_data: TeacherUpdate, tenant_id: str
    ) -> Optional[Teacher]:
    ...
    def assign_subject(
        self, teacher_id: int, subject_id: int, class_id: int, tenant_id: str
    ) -> bool:
