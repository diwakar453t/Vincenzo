...
class ClassService:
    ...
    def create_class(self, class_data: ClassCreate, tenant_id: str) -> Class:
        """Create a new class"""
        class_obj = Class(**class_data.model_dump(), tenant_id=tenant_id)
    ...
    def update_class(
        self, class_id: int, class_data: ClassUpdate, tenant_id: str
    ) -> Optional[Class]:
    ...
    def get_class_students(self, class_id: int, tenant_id: str) -> List[Student]:
    ...
    def assign_students(
        self, class_id: int, student_ids: List[int], tenant_id: str
    ) -> int:
        """
