...
_DEFAULT_FLAGS = {
    "ai_study_assistant": {
        "enabled": True,
        "scope": "Premium+",
        "description": "Student AI tutor",
    },
    "face_recognition_attendance": {
        "enabled": False,
        "scope": "Enterprise",
        "description": "Biometric check-in",
    },
    "whatsapp_notifications": {
        "enabled": True,
        "scope": "Standard+",
        "description": "WA Business API",
    },
    "analytics_v2_beta": {
        "enabled": False,
        "scope": "Beta",
        "description": "New ML-powered insights",
    },
    "digital_library": {
        "enabled": True,
        "scope": "Premium+",
        "description": "e-Book integration",
    },
    "online_fee_payment": {
        "enabled": True,
        "scope": "Standard+",
        "description": "Razorpay/Stripe gateway",
    },
    "transport_tracking": {
        "enabled": False,
        "scope": "Enterprise",
        "description": "Live GPS bus tracking",
    },
    "hostel_management": {
        "enabled": True,
        "scope": "Standard+",
    ...
    "multi_campus": {
        "enabled": False,
        "scope": "Enterprise",
        "description": "Multiple campus support",
    },
    "parent_app": {
        "enabled": True,
        "scope": "Standard+",
        "description": "Parent mobile portal",
    },
}
...
def toggle_feature_flag(
    ...
    try:
        ...
        svc = SettingsService(db)
        svc.upsert_setting(
            key=f"flag_{flag_name}", value=str(body.enabled).lower(), tenant_id=None
        )
    except Exception:
