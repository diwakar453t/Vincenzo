...
class PaymentTransaction(BaseModel):
    ...
    payment_method = Column(
        Enum(
            TransactionPaymentMethod, name="transactionpaymentmethod", create_type=True
        ),
        default=TransactionPaymentMethod.upi,
        nullable=False,
    )
    purpose = Column(
        Enum(PaymentPurpose), default=PaymentPurpose.tuition_fee, nullable=False
    )
    ...
    # Fee linkage
    fee_assignment_id = Column(
        Integer, nullable=True
    )  # links to student_fee_assignments
