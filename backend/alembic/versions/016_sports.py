...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            "max_participants", sa.Integer(), nullable=False, server_default="30"
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "sport_id",
            sa.Integer(),
            sa.ForeignKey("sports.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "student_id",
    ...
    op.create_index(
        "ix_sport_participations_tenant_id", "sport_participations", ["tenant_id"]
    )
    op.create_index(
        "ix_sport_participations_sport_id", "sport_participations", ["sport_id"]
    )
    op.create_index(
        "ix_sport_participations_student_id", "sport_participations", ["student_id"]
    )
    ...
    op.create_index(
        "ix_sport_achievements_tenant_id", "sport_achievements", ["tenant_id"]
    )
    op.create_index(
        "ix_sport_achievements_sport_id", "sport_achievements", ["sport_id"]
    )
