...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_student_attendance_tenant_id"), "student_attendance", ["tenant_id"]
    )
    ...
    op.create_index(
        op.f("ix_staff_attendance_tenant_id"), "staff_attendance", ["tenant_id"]
    )
    op.create_index("ix_staff_attendance_date", "staff_attendance", ["date"])
    op.create_index(
        "ix_staff_attendance_teacher_date",
        "staff_attendance",
        ["teacher_id", "date"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_student_attendance_tenant_id"), table_name="student_attendance"
    )
