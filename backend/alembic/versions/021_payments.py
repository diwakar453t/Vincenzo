...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            "payment_method", sa.String(20), nullable=False, server_default="upi"
        ),
        sa.Column(
            "purpose", sa.String(30), nullable=False, server_default="tuition_fee"
        ),
    ...
    op.create_index(
        "ix_payment_transactions_student", "payment_transactions", ["student_id"]
    )
    op.create_index(
        "ix_payment_transactions_payer", "payment_transactions", ["payer_user_id"]
    )
