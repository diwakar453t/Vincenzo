...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "exam_type", sa.String(length=30), nullable=False, server_default="mid_term"
        ),
        sa.Column("academic_year", sa.String(length=20), nullable=False),
        sa.Column(
            "status", sa.String(length=20), nullable=False, server_default="upcoming"
        ),
    ...
    op.create_index(
        op.f("ix_exam_schedules_tenant_id"), "exam_schedules", ["tenant_id"]
    )
