...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "component_type",
            sa.Enum("earning", "deduction", name="componenttype"),
            nullable=False,
        ),
        sa.Column("is_percentage", sa.Boolean(), nullable=False, server_default="false"),
    ...
    op.create_index(
        "ix_payroll_components_tenant_id", "payroll_components", ["tenant_id"]
    )
    ...
    op.create_index(
        "ix_salary_structures_tenant_id", "salary_structures", ["tenant_id"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["structure_id"], ["salary_structures.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["component_id"], ["payroll_components.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("draft", "processed", "approved", "paid", name="payrollstatus"),
            nullable=False,
