...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "member_type", sa.String(20), nullable=False, server_default="student"
        ),
        sa.Column(
            "student_id",
            sa.Integer(),
        ...
        sa.Column(
            "max_books_allowed", sa.Integer(), nullable=False, server_default="3"
        ),
    ...
    op.create_index(
        "ix_library_members_member_code", "library_members", ["member_code"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "member_id",
            sa.Integer(),
            sa.ForeignKey("library_members.id", ondelete="CASCADE"),
            nullable=False,
        ),
