...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["fee_group_id"], ["fee_groups.id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("paid", "partial", "unpaid", "overdue", name="paymentstatus"),
            nullable=False,
    ...
    op.create_index(
        "ix_student_fee_assignments_student_id",
        "student_fee_assignments",
        ["student_id"],
    )
    op.create_index(
        "ix_student_fee_assignments_status", "student_fee_assignments", ["status"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["fee_type_id"], ["fee_types.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["assignment_id"], ["student_fee_assignments.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_index(
        "ix_fee_collections_payment_date", "fee_collections", ["payment_date"]
    )
